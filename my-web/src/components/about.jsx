...
export default function About () {
	return (<div>
				<div className = "DivsProp">
					...
					<img src = "https://www.diariosumario.com.ar/u/fotografias/fotosnoticias/2020/8/12/24313.jpg" className = "ImgAbout" />
				</div>
				...
				<div className = "DivsProp">
            		...
            		<img src = "http://prensarealestate.com/wp-content/uploads/2018/09/agencias-viaje.jpg" className = "ImgAbout" />
				</div>
				

				<div className = "DivsProp">
					<h2 className = "title"> PRINCIPALES OBJETIVOS </h2>
					<ul className = "textAbout">
					<li>Brindar un alto nivel de servicios adecuados para personas que buscan experiencias relajantes, cómodas y memorables en la industria hotelera y turística.</li>
					<li>Evaluar los problemas culturales, económicos y sociales actuales que afectan la industria del turismo y los viajes.</li>
					<li>Ofrecer los servicios de viaje a precios muy razonables.</li>
					<li>Ser una empresa conocida por su honestidad y transparencia al brindarle las mejores soluciones de viaje para su negocio.</li>
