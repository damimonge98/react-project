...
export default function destineShow (props) {
	...
	switch (props.name) {
		...
		case "Buenos Aires":
			...
			break;
		case "Mendoza":
			info = "Vinos, montañas, ríos, con una identidad forjada por la herencia europea y las huellas indígenas. Mendoza, recostada sobre los Andes al oeste de Argentina, presenta una recomendada propuesta gastronómica con paisajes que asombran al visitante. El legado de las colectividades europeas que llegaron a estas tierras a principios del siglo XX marcó a fuego la identidad de Mendoza. El vino es uno de sus motores económicos más importantes, y uno de los reclamos turísticos más valiosos con las experiencias que ofrecen sus bodegas. En la provincia se rinde culto a sus tintos y blancos, en especial al malbec, la cepa distintiva que hizo famoso al vino argentino en todo el planeta. En la provincia hay 146 establecimientos dedicados al turismo del vino. Muchas ofrecen degustaciones de gastronomía, otras tienen elegantes wine bar para degustar por copas, están las que ofrecen actividades que van desde spa o paseos en bicicleta hasta conciertos de música clásica. Y alguna con más de cien años de historia tiene museo propio. Las bodegas más importantes se concentran en las comarcas de Luján de Cuyo y Maipú, que se despliegan a poco más de media hora del centro de la capital."
